        ...
        return(
            <div className='events-page'>
                <div className={`councils ${this.state.className}`}  onClick={this.state.className === null ? this.onClickFirstDiv: null}>
                    <div className='content-wrapper' style={{ backgroundImage: `url(${eventsAdhyaayImage})`}}>
                        <div className='content-wrapper--title'>
                            ANDAAZ
                            <span className='content-wrapper--title-secondary'>View Events &rarr;</span>
                        </div>
                        { this.state.className && <button className='back-button' onClick={this.buttonClick}> <img src={arrowImage} alt='back' /> </button>}
                ...
                <div className={`councils ${this.state.className}`} onClick={this.state.className === null ? this.onClickSecondDiv: null}>
                    <div className='content-wrapper' style={{ backgroundImage: `url(${eventsHobbyImage})`}}>
                        <div className='content-wrapper--title'>
                            AAGAZ
                            <span className='content-wrapper--title-secondary'>View Events &rarr;</span>
                        </div>
                        { (this.state.className && this.state.buttonDisplay) && <button className='back-button' onClick={this.buttonClick}> <img src={arrowImage} alt='back' /> </button>}
                        { (this.state.className === 'second'  && this.state.timeOut) && <HobbyEvents buttonDisplay={this.buttonDisplay} buttonHide={this.buttonHide} />}
                    </div>
                </div>
                <div className={`councils ${this.state.className}`} onClick={this.state.className === null ? this.onClickThirdDiv: null}>
                    <div className='content-wrapper' style={{ backgroundImage: `url(${eventsLitImage})`}}>
                        <div className='content-wrapper--title'>
                            ALFAAZ
                            <span className='content-wrapper--title-secondary'>View Events &rarr;</span>
                        </div>
                        { (this.state.className && this.state.buttonDisplay) && <button className='back-button' onClick={this.buttonClick}> <img src={arrowImage} alt='back' /> </button>}
                        { (this.state.className === 'third' && this.state.timeOut) && <LitEvents buttonDisplay={this.buttonDisplay} buttonHide={this.buttonHide} />}
                    </div>
                </div>
            </div>
        )
